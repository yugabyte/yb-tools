...
/* EditOK describes a response with status code 200, with default header values.
...
func (o *EditOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/universes/{uniUUID}/xcluster_replication][%d] editOK  %+v", 200, o.Payload)
}
func (o *EditOK) GetPayload() *models.YBPTask {
	return o.Payload
}
