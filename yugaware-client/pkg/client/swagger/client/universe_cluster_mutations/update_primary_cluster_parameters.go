...
func NewUpdatePrimaryClusterParams() *UpdatePrimaryClusterParams {
	return &UpdatePrimaryClusterParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewUpdatePrimaryClusterParamsWithTimeout creates a new UpdatePrimaryClusterParams object
...
// NewUpdatePrimaryClusterParamsWithContext creates a new UpdatePrimaryClusterParams object
...
// NewUpdatePrimaryClusterParamsWithHTTPClient creates a new UpdatePrimaryClusterParams object
...
func (o *UpdatePrimaryClusterParams) WithDefaults() *UpdatePrimaryClusterParams {
	o.SetDefaults()
	return o
}
...
func (o *UpdatePrimaryClusterParams) WithTimeout(timeout time.Duration) *UpdatePrimaryClusterParams {
...
func (o *UpdatePrimaryClusterParams) WithContext(ctx context.Context) *UpdatePrimaryClusterParams {
	o.SetContext(ctx)
	return o
}
...
func (o *UpdatePrimaryClusterParams) WithHTTPClient(client *http.Client) *UpdatePrimaryClusterParams {
...
func (o *UpdatePrimaryClusterParams) WithUniUUID(uniUUID strfmt.UUID) *UpdatePrimaryClusterParams {
...
func (o *UpdatePrimaryClusterParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
