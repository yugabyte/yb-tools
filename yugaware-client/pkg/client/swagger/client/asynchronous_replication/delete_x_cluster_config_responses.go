...
func (o *DeleteXClusterConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteXClusterConfigOK()
...
func (o *DeleteXClusterConfigOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/customers/{cUUID}/xcluster_configs/{xccUUID}][%d] deleteXClusterConfigOK  %+v", 200, o.Payload)
}
func (o *DeleteXClusterConfigOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *DeleteXClusterConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
