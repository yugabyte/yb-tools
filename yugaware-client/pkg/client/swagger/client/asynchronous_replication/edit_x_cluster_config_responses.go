...
func (o *EditXClusterConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewEditXClusterConfigOK()
...
func (o *EditXClusterConfigOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/xcluster_configs/{xccUUID}][%d] editXClusterConfigOK  %+v", 200, o.Payload)
}
func (o *EditXClusterConfigOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *EditXClusterConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
