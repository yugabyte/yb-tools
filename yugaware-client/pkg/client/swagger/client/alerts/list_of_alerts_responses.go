...
func (o *ListOfAlertsOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/alerts][%d] listOfAlertsOK  %+v", 200, o.Payload)
}
func (o *ListOfAlertsOK) GetPayload() []*models.Alert {
	return o.Payload
}

func (o *ListOfAlertsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
