...
func (o *GetAlertChannelOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/alert_channels/{acUUID}][%d] getAlertChannelOK  %+v", 200, o.Payload)
}
func (o *GetAlertChannelOK) GetPayload() *models.AlertChannel {
	return o.Payload
}

func (o *GetAlertChannelOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
