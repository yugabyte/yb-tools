...
func (o *GetAlertConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetAlertConfigurationOK()
...
func NewGetAlertConfigurationOK() *GetAlertConfigurationOK {
	return &GetAlertConfigurationOK{}
}
...
func (o *GetAlertConfigurationOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/alert_configurations/{configurationUUID}][%d] getAlertConfigurationOK  %+v", 200, o.Payload)
}
func (o *GetAlertConfigurationOK) GetPayload() *models.AlertConfiguration {
	return o.Payload
}

func (o *GetAlertConfigurationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
