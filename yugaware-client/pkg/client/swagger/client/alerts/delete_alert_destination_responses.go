...
func (o *DeleteAlertDestinationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteAlertDestinationOK()
...
func NewDeleteAlertDestinationOK() *DeleteAlertDestinationOK {
	return &DeleteAlertDestinationOK{}
}
...
func (o *DeleteAlertDestinationOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/customers/{cUUID}/alert_destinations/{adUUID}][%d] deleteAlertDestinationOK  %+v", 200, o.Payload)
}
func (o *DeleteAlertDestinationOK) GetPayload() *models.YBPSuccess {
	return o.Payload
}

func (o *DeleteAlertDestinationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
