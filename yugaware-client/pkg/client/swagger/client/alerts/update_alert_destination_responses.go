...
func (o *UpdateAlertDestinationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateAlertDestinationOK()
...
func NewUpdateAlertDestinationOK() *UpdateAlertDestinationOK {
	return &UpdateAlertDestinationOK{}
}
...
func (o *UpdateAlertDestinationOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/alert_destinations/{adUUID}][%d] updateAlertDestinationOK  %+v", 200, o.Payload)
}
func (o *UpdateAlertDestinationOK) GetPayload() *models.AlertDestination {
	return o.Payload
}

func (o *UpdateAlertDestinationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.AlertDestination)
