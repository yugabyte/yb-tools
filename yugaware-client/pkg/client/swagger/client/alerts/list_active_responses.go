...
func (o *ListActiveOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/alerts/active][%d] listActiveOK  %+v", 200, o.Payload)
}
func (o *ListActiveOK) GetPayload() []*models.Alert {
	return o.Payload
}

func (o *ListActiveOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
