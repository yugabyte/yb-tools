...
func (o *CreateAlertDestinationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateAlertDestinationOK()
...
func (o *CreateAlertDestinationOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/alert_destinations][%d] createAlertDestinationOK  %+v", 200, o.Payload)
}
func (o *CreateAlertDestinationOK) GetPayload() *models.AlertDestination {
	return o.Payload
}

func (o *CreateAlertDestinationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
