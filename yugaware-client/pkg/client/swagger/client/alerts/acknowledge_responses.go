...
func (o *AcknowledgeOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/alerts/{alertUUID}/acknowledge][%d] acknowledgeOK  %+v", 200, o.Payload)
}
func (o *AcknowledgeOK) GetPayload() *models.Alert {
	return o.Payload
}

func (o *AcknowledgeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
