...
func (o *CreateAlertChannelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateAlertChannelOK()
...
func (o *CreateAlertChannelOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/alert_channels][%d] createAlertChannelOK  %+v", 200, o.Payload)
}
func (o *CreateAlertChannelOK) GetPayload() *models.AlertChannel {
	return o.Payload
}

func (o *CreateAlertChannelOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
