...
func (o *GetAlertDestinationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetAlertDestinationOK()
...
func (o *GetAlertDestinationOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/alert_destinations/{adUUID}][%d] getAlertDestinationOK  %+v", 200, o.Payload)
}
func (o *GetAlertDestinationOK) GetPayload() *models.AlertDestination {
	return o.Payload
}

func (o *GetAlertDestinationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
