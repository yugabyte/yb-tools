...
func (o *CountAlertsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/alerts/count][%d] countAlertsOK  %+v", 200, o.Payload)
}
func (o *CountAlertsOK) GetPayload() int32 {
	return o.Payload
}

func (o *CountAlertsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
