...
func (o *DeleteAlertChannelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteAlertChannelOK()
...
func (o *DeleteAlertChannelOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/customers/{cUUID}/alert_channels/{acUUID}][%d] deleteAlertChannelOK  %+v", 200, o.Payload)
}
func (o *DeleteAlertChannelOK) GetPayload() *models.YBPSuccess {
	return o.Payload
}

func (o *DeleteAlertChannelOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
