...
func (o *ListAlertTemplatesOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/alert_templates][%d] listAlertTemplatesOK  %+v", 200, o.Payload)
}
func (o *ListAlertTemplatesOK) GetPayload() []*models.AlertConfigurationTemplate {
	return o.Payload
}
