...
func (o *GrafanaDashboardOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/grafana_dashboard][%d] grafanaDashboardOK  %+v", 200, o.Payload)
}
func (o *GrafanaDashboardOK) GetPayload() string {
	return o.Payload
}

func (o *GrafanaDashboardOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
