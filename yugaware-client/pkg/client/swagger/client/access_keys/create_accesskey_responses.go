...
func (o *CreateAccesskeyOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/providers/{pUUID}/access_keys][%d] createAccesskeyOK  %+v", 200, o.Payload)
}
func (o *CreateAccesskeyOK) GetPayload() *models.AccessKey {
	return o.Payload
}

func (o *CreateAccesskeyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
