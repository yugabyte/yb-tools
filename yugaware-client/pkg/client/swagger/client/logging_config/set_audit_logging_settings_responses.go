...
func (o *SetAuditLoggingSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSetAuditLoggingSettingsOK()
...
func (o *SetAuditLoggingSettingsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/audit_logging_config][%d] setAuditLoggingSettingsOK  %+v", 200, o.Payload)
}
func (o *SetAuditLoggingSettingsOK) GetPayload() *models.AuditLoggingConfig {
	return o.Payload
}

func (o *SetAuditLoggingSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.AuditLoggingConfig)
