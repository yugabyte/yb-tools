...
func (o *ToggleUniverseTLSOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/universes/{uniUUID}/toggle_tls][%d] toggleUniverseTlsOK  %+v", 200, o.Payload)
}
func (o *ToggleUniverseTLSOK) GetPayload() *models.UniverseResp {
	return o.Payload
}

func (o *ToggleUniverseTLSOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
