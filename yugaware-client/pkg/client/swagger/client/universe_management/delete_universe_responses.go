...
func (o *DeleteUniverseOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/customers/{cUUID}/universes/{uniUUID}][%d] deleteUniverseOK  %+v", 200, o.Payload)
}
func (o *DeleteUniverseOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *DeleteUniverseOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
