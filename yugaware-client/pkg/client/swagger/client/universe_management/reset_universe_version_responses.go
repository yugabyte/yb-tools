...
func (o *ResetUniverseVersionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewResetUniverseVersionOK()
...
func (o *ResetUniverseVersionOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/universes/{uniUUID}/setup_universe_2dc][%d] resetUniverseVersionOK  %+v", 200, o.Payload)
}
func (o *ResetUniverseVersionOK) GetPayload() *models.YBPSuccess {
	return o.Payload
}

func (o *ResetUniverseVersionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
