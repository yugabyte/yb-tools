...
func (o *SetUniverseBackupFlagReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSetUniverseBackupFlagOK()
...
func NewSetUniverseBackupFlagOK() *SetUniverseBackupFlagOK {
	return &SetUniverseBackupFlagOK{}
}
...
func (o *SetUniverseBackupFlagOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/universes/{uniUUID}/update_backup_state][%d] setUniverseBackupFlagOK  %+v", 200, o.Payload)
}
func (o *SetUniverseBackupFlagOK) GetPayload() *models.YBPSuccess {
	return o.Payload
}

func (o *SetUniverseBackupFlagOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
