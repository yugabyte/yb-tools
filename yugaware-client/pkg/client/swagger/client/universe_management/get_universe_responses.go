...
func (o *GetUniverseOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/universes/{uniUUID}][%d] getUniverseOK  %+v", 200, o.Payload)
}
func (o *GetUniverseOK) GetPayload() *models.UniverseResp {
	return o.Payload
}

func (o *GetUniverseOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
