...
func (o *GetYQLServerAddressesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetYQLServerAddressesOK()
...
func (o *GetYQLServerAddressesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/universes/{uniUUID}/yqlservers][%d] getYQLServerAddressesOK  %+v", 200, o.Payload)
}
func (o *GetYQLServerAddressesOK) GetPayload() string {
	return o.Payload
}

func (o *GetYQLServerAddressesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
