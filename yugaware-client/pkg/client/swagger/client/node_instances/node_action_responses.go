...
func (o *NodeActionOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/universes/{universeUUID}/nodes/{nodeName}][%d] nodeActionOK  %+v", 200, o.Payload)
}
func (o *NodeActionOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *NodeActionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
