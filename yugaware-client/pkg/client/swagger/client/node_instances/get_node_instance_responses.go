...
func (o *GetNodeInstanceOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/nodes/{nodeUUID}/list][%d] getNodeInstanceOK  %+v", 200, o.Payload)
}
func (o *GetNodeInstanceOK) GetPayload() *models.NodeInstance {
	return o.Payload
}

func (o *GetNodeInstanceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.NodeInstance)
