...
func (o *ListByProviderOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/providers/{pUUID}/nodes/list][%d] listByProviderOK  %+v", 200, o.Payload)
}
func (o *ListByProviderOK) GetPayload() []*models.NodeInstance {
	return o.Payload
}

func (o *ListByProviderOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
