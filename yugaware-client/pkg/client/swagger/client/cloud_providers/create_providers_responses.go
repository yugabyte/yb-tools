...
func (o *CreateProvidersOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/providers][%d] createProvidersOK  %+v", 200, o.Payload)
}
func (o *CreateProvidersOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *CreateProvidersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
