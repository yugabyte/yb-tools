...
func (o *EditProviderOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/providers/{pUUID}/edit][%d] editProviderOK  %+v", 200, o.Payload)
}
func (o *EditProviderOK) GetPayload() *models.Provider {
	return o.Payload
}

func (o *EditProviderOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
