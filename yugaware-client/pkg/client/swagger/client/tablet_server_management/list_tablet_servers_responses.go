...
func (o *ListTabletServersOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/universes/{uniUUID}/tablet-servers][%d] listTabletServersOK  %+v", 200, o.Payload)
}
func (o *ListTabletServersOK) GetPayload() map[string]interface{} {
	return o.Payload
}

func (o *ListTabletServersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
