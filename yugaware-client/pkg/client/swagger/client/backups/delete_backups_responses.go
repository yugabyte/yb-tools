...
func (o *DeleteBackupsOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/customers/{cUUID}/backups][%d] deleteBackupsOK  %+v", 200, o.Payload)
}
func (o *DeleteBackupsOK) GetPayload() models.YBPTasks {
	return o.Payload
}

func (o *DeleteBackupsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
