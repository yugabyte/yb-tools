...
type CreateParams struct {
	...
	CreateMaintenanceWindowRequest *models.MaintenanceWindow
...
// WithCreateMaintenanceWindowRequest adds the createMaintenanceWindowRequest to the create params
func (o *CreateParams) WithCreateMaintenanceWindowRequest(createMaintenanceWindowRequest *models.MaintenanceWindow) *CreateParams {
	o.SetCreateMaintenanceWindowRequest(createMaintenanceWindowRequest)
	return o
}

// SetCreateMaintenanceWindowRequest adds the createMaintenanceWindowRequest to the create params
func (o *CreateParams) SetCreateMaintenanceWindowRequest(createMaintenanceWindowRequest *models.MaintenanceWindow) {
	o.CreateMaintenanceWindowRequest = createMaintenanceWindowRequest
}

// WithCUUID adds the cUUID to the create params
func (o *CreateParams) WithCUUID(cUUID strfmt.UUID) *CreateParams {
	o.SetCUUID(cUUID)
	return o
}

// SetCUUID adds the cUuid to the create params
func (o *CreateParams) SetCUUID(cUUID strfmt.UUID) {
	o.CUUID = cUUID
}
...
func (o *CreateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.CreateMaintenanceWindowRequest != nil {
		if err := r.SetBodyParam(o.CreateMaintenanceWindowRequest); err != nil {
			return err
		}
	}
