...
func (o *DeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/customers/{cUUID}/maintenance_windows/{windowUUID}][%d] deleteOK  %+v", 200, o.Payload)
}
func (o *DeleteOK) GetPayload() *models.YBPSuccess {
	return o.Payload
}
