...
func (o *UpdateOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/maintenance_windows/{windowUUID}][%d] updateOK  %+v", 200, o.Payload)
}
func (o *UpdateOK) GetPayload() *models.MaintenanceWindow {
	return o.Payload
}
