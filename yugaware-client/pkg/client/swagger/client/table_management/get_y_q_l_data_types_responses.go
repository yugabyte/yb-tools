...
func (o *GetYQLDataTypesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/metadata/yql_data_types][%d] getYQLDataTypesOK  %+v", 200, o.Payload)
}
func (o *GetYQLDataTypesOK) GetPayload() []string {
	return o.Payload
}

func (o *GetYQLDataTypesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
