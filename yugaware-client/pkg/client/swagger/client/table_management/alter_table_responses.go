...
func (o *AlterTableOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/customers/{cUUID}/universes/{uniUUID}/tables/{tableUUID}][%d] alterTableOK  %+v", 200, o.Payload)
}
func (o *AlterTableOK) GetPayload() map[string]interface{} {
	return o.Payload
}

func (o *AlterTableOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
