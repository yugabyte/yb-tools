...
func (o *GetListOfReleasesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/releases][%d] getListOfReleasesOK  %+v", 200, o.Payload)
}
func (o *GetListOfReleasesOK) GetPayload() map[string]interface{} {
	return o.Payload
}

func (o *GetListOfReleasesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
