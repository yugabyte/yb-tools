...
func (o *HealthCheckUniverseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewHealthCheckUniverseOK()
...
func (o *HealthCheckUniverseOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/universes/{uniUUID}/health_check][%d] healthCheckUniverseOK  %+v", 200, o.Payload)
}
func (o *HealthCheckUniverseOK) GetPayload() interface{} {
	return o.Payload
}

func (o *HealthCheckUniverseOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
