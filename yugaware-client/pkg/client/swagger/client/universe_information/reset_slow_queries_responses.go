...
func (o *ResetSlowQueriesOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/customers/{cUUID}/universes/{uniUUID}/slow_queries][%d] resetSlowQueriesOK  %+v", 200, o.Payload)
}
func (o *ResetSlowQueriesOK) GetPayload() interface{} {
	return o.Payload
}

func (o *ResetSlowQueriesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
