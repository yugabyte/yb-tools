...
func (o *GetUniverseCostForAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetUniverseCostForAllOK()
...
func NewGetUniverseCostForAllOK() *GetUniverseCostForAllOK {
	return &GetUniverseCostForAllOK{}
}
...
func (o *GetUniverseCostForAllOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/cost][%d] getUniverseCostForAllOK  %+v", 200, o.Payload)
}
func (o *GetUniverseCostForAllOK) GetPayload() []*models.UniverseResourceDetails {
	return o.Payload
}

func (o *GetUniverseCostForAllOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
