...
func (o *GetMasterLeaderIPOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers/{cUUID}/universes/{uniUUID}/leader][%d] getMasterLeaderIpOK  %+v", 200, o.Payload)
}
func (o *GetMasterLeaderIPOK) GetPayload() interface{} {
	return o.Payload
}

func (o *GetMasterLeaderIPOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
