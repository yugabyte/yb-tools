...
func (o *UpgradeVMImageOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/universes/{uniUUID}/upgrade/vm][%d] upgradeVmImageOK  %+v", 200, o.Payload)
}
func (o *UpgradeVMImageOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *UpgradeVMImageOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
