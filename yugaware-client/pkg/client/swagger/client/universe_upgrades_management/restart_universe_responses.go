...
func (o *RestartUniverseOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/universes/{uniUUID}/upgrade/restart][%d] restartUniverseOK  %+v", 200, o.Payload)
}
func (o *RestartUniverseOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *RestartUniverseOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
