...
func (o *UpgradeSoftwareOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/universes/{uniUUID}/upgrade/software][%d] upgradeSoftwareOK  %+v", 200, o.Payload)
}
func (o *UpgradeSoftwareOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *UpgradeSoftwareOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
