...
func (o *ResizeNodeOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/customers/{cUUID}/universes/{uniUUID}/upgrade/resize_node][%d] resizeNodeOK  %+v", 200, o.Payload)
}
func (o *ResizeNodeOK) GetPayload() *models.YBPTask {
	return o.Payload
}

func (o *ResizeNodeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
