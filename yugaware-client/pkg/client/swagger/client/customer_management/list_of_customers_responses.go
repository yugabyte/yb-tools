...
func (o *ListOfCustomersOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customers][%d] listOfCustomersOK  %+v", 200, o.Payload)
}
func (o *ListOfCustomersOK) GetPayload() []*models.Customer {
	return o.Payload
}

func (o *ListOfCustomersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
