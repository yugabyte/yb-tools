...
func (m *MastersList) validateMasters(formats strfmt.Registry) error {
...
func (m *MastersList) contextValidateMasters(ctx context.Context, formats strfmt.Registry) error {
