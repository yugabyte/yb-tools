...
var file_yb_util_histogram_proto_rawDesc = []byte{
...
var (
	...
	file_yb_util_histogram_proto_rawDescData = file_yb_util_histogram_proto_rawDesc
)

func file_yb_util_histogram_proto_rawDescGZIP() []byte {
	file_yb_util_histogram_proto_rawDescOnce.Do(func() {
		file_yb_util_histogram_proto_rawDescData = protoimpl.X.CompressGZIP(file_yb_util_histogram_proto_rawDescData)
	})
	return file_yb_util_histogram_proto_rawDescData
}

var file_yb_util_histogram_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_yb_util_histogram_proto_goTypes = []interface{}{
...
func file_yb_util_histogram_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yb_util_histogram_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HistogramSnapshotPB); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yb_util_histogram_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HistogramSnapshotsListPB); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yb_util_histogram_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_yb_util_histogram_proto_rawDesc = nil
