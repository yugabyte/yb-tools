...
our $USAGE = << "__USAGE__";
  ...
  The "tablet report" is a "*.out" generated by yugatool.
  The "Support bundle" creates a ".tar.gz" file that need to be extracted. Pass the extracted $ANSICOLOR{CYAN}directory name$ANSICOLOR{NORMAL} to this script.

  This will create and output database file named $ANSICOLOR{GREEN}TABLET-REPORT.sqlite$ANSICOLOR{NORMAL}
